package my.creation.womenbesafe;
...
public class Activity2 extends AppCompatActivity {
    ...
    private void loadData(){
        ...
        if(data.getCount()==0){
            Toast.makeText(this,"No any number added for emergency",Toast.LENGTH_SHORT).show();
        }
        else{
            String msg="Help Me My Location is : https://www.google.com/maps/search/?api=1&query=" +x + "," +y;
            String number = "";
